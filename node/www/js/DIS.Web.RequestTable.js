    ...
    getMonthUsage: function (searchMonth) {
        ...
        htmlStr += "<div class='usageBox'>\
                        ...
                        <div class='tbHeader'>\
                            ...
                            <div class='additional_encrypt_upload_header'><h3>추가 비식별화<br/>요청 건수</h3></div>\
        ...
        for(var keys in usageObject){
                htmlStr += "<div class='tbContent'>\
                                ...
                                <div class='additional_encrypt_upload_content'><p>"+usageObject[keys]['additional_encrypt_request_count']+"</p></div>\
        ...
        htmlStr += `<div class='usageBox'>
                        ...
                        <div class='tbHeader'>
                            ...
                            <div class='additional_encrypt_charge_header'><h3>추가 비식별화<br/>서비스 요금</h3></div>
        ...
        for(var keys in usageObject) {
            ...
            let totalAdditionalEnvryptCharge = Number(usageObject[keys]['additional_encrypt_request_charge']);
            let totalDownloadCharge = Number(usageObject[keys]['download_request_charge']);
            let totalCharge = totalEncryptCharge + totalDecryptCharge + totalDownloadCharge + totalAdditionalEnvryptCharge;

            htmlStr += `<div class='tbContent'>
                            <div class='tenant_content'><p>${keys}</p></div>\
                            <div class='user_content'><p>${usageObject[keys]['company_name']}</p></div>
                            <div class='encrypt_charge_content'><p>${totalEncryptCharge.toLocaleString('en-US')} 원</p></div>
                            <div class='additional_encrypt_charge_content'><p>${totalAdditionalEnvryptCharge.toLocaleString('en-US')} 원</p></div>
